...
public class RightAccessDao {
	private final static Logger LOG = Logger.getLogger("RightAccessDao.class");
		...
		return (List<UserRightModel>) new JdbcControl().query(sql, new QueryCallBack() {
			...
			public Object onCallBack(ResultSet rs) throws SQLException {
				...
				while (rs.next()) {
					...
					LOG.info("userId:" + rs.getInt("userId") + " ;menuHeadId:" + rs.getInt("headId") + " ;menu1Id:"
							+ rs.getInt("menu1Id") + " ;menu2Id:" + rs.getInt("menu2Id"));
					if (0 == menu2Id)
						continue;
