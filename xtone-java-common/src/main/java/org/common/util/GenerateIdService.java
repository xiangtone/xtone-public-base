...
public class GenerateIdService {
	...
	public static final long SERVER_ADD_MS_SPEND_LIMIT = 100000L;
	public static final int MS_SPEND_LIMIT = 1000;
	...
	public static void main(String[] args) {
		...
		// System.out.println(GenerateIdService.generateNew(validServerId, "",
		// GenerateIdService.MS_SPEND_LIMIT - 1));
		// System.out.println(GenerateIdService.generateNew(validServerId, "",
		// GenerateIdService.MS_SPEND_LIMIT - 1));
		// System.out.println(GenerateIdService.generateNew(validServerId, "",
		// GenerateIdService.MS_SPEND_LIMIT - 1));
		...
		// System.out.println(GenerateIdService.generateNew(validServerId, "",
		// GenerateIdService.MS_SPEND_LIMIT - 1));
		// GenerateIdService.generateNew(validServerId, "",
		// GenerateIdService.MS_SPEND_LIMIT - 1);
		// GenerateIdService.generateNew(validServerId, "",
		// GenerateIdService.MS_SPEND_LIMIT - 1);
		// GenerateIdService.generateNew(validServerId, "",
